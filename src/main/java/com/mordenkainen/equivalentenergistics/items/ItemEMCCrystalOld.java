...
public class ItemEMCCrystalOld extends ItemMultiBase implements IEnergyValueProvider, IConfigurable {
    ...
    public final static double[] CRYSTAL_VALUES = { 256, 147456, 84934656 };
    ...
    public void loadConfig(final Configuration config) {
        CRYSTAL_VALUES[0] = config.get("General", "CrystalEMC", CRYSTAL_VALUES[0]).getDouble(CRYSTAL_VALUES[0]);
        CRYSTAL_VALUES[1] = CRYSTAL_VALUES[0] * 576;
        CRYSTAL_VALUES[2] = CRYSTAL_VALUES[0] * Math.pow(576, 2);
    }
