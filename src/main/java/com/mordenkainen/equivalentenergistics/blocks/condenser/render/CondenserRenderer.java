...
public class CondenserRenderer extends FastTESR<TileEMCCondenserExt> {
    @Override
    public void renderTileEntityFast(final TileEMCCondenserExt te, final double x, final double y, final double z, final float partialTicks, final int destroyStage, final VertexBuffer buffer) {
        final BlockPos pos = te.getPos();
        final int lightCoords = Minecraft.getMinecraft().theWorld.getBlockState(pos).getPackedLightmapCoords(Minecraft.getMinecraft().theWorld, pos);
